...
#define CC_CORE_H
/*
Core fixed-size integer types, automatic platform detection, and common small
structs Copyright 2014-2025 ClassiCube | Licensed under BSD-3
*/
...
#ifdef __INT8_TYPE__
/* avoid including <stdint.h> because it breaks defining UNICODE in Platform.c
 * with MinGW */
...
#define CC_GFX_BACKEND_IS_GL()                                                 \
  (CC_GFX_BACKEND == CC_GFX_BACKEND_GL1 ||                                     \
   ...
   CC_GFX_BACKEND == CC_GFX_BACKEND_GL11)
...
#define CC_FPU_MODE_MINIMAL                                                    \
  1 /* Integer math funcs, no animations, no held block, flat inventory */
#define CC_FPU_MODE_LIMITED                                                    \
  2 /* Integer math funcs, no animations, no held block */
...
#undef CC_VAR
#elif defined PLAT_TI84
#define CC_BUILD_TI84
#define CC_BUILD_CONSOLE
#define CC_BUILD_LOWMEM
#define CC_BUILD_TINYMEM
#define CC_BUILD_COOPTHREADED
#define CC_BUILD_NOMUSIC
#define CC_BUILD_NOSOUNDS
#define CC_BUILD_MAXSTACK (4 * 1024)
#define CC_BUILD_FPU_MODE CC_FPU_MODE_MINIMAL
#undef CC_BUILD_RESOURCES
#undef CC_BUILD_NETWORKING
#undef CC_BUILD_ADVLIGHTING
...
#define CC_BUILD_NOSOUNDS
#define CC_BUILD_TOUCH
#define CC_BUILD_MAXSTACK                                                      \
  (16 * 1024) /* Only < 16 kb stack as it's in DTCM region */
...
// TODO We deactivate the OS/2 audio, because we get hard system crashes upon
// app exit.
...
#define DEFAULT_GFX_BACKEND CC_GFX_BACKEND_SOFTMIN
#define DEFAULT_AUD_BACKEND CC_AUD_BACKEND_NULL
#elif defined PLAT_ESP32
#define CC_BUILD_ESP32
#define CC_BUILD_CONSOLE
#define CC_BUILD_LOWMEM
#define CC_BUILD_COOPTHREADED
#define CC_BUILD_NOMUSIC
...
#define DEFAULT_GFX_BACKEND CC_GFX_BACKEND_SOFTMIN
#define DEFAULT_AUD_BACKEND CC_AUD_BACKEND_NULL
#elif defined PLAT_WASM
#define CC_BUILD_WASM
#define CC_BUILD_CONSOLE
#define CC_BUILD_COOPTHREADED
#define CC_BUILD_NOMUSIC
#define CC_BUILD_NOSOUNDS
...
/* Use platform default unless override is provided via command
 * line/makefile/etc */
...
typedef union cc_pointer_ {
  cc_uintptr val;
  void *ptr;
} cc_pointer;

typedef struct Rect2D_ {
...
/* Indicates that a reference to the buffer in a string argument is persisted
after the function has completed. Thus it is **NOT SAFE** to allocate a string
on the stack. */
#define STRING_REF
